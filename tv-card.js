...
class TVCardServices extends LitElement {
    ...
    onClick(event) {
        ...
        let click_action = () => {
            ...
            if (this._config.enable_button_feedback === undefined || this._config.enable_button_feedback) fireEvent(window, "haptic", "medium");
        };  
    ...
    onTouchStart(event) {
        ...
        this.holdtimer = setTimeout(() => {
            ...
            this.holdinterval = setInterval(() => {
                ...
                if (this._config.enable_button_feedback === undefined || this._config.enable_button_feedback) fireEvent(window, "haptichaptic", "light");
            }, 200);
        }, 700);
